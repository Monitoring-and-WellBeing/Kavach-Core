...
CREATE INDEX IF NOT EXISTS idx_ai_usage_student_date
...
-- Mood Check-ins -----------------------------------------------------------
-- NOTE: V23 redefines mood_checkins without student_id.
--       This table is superseded by V23's schema; see V27 for the schema reconciliation.
...
CREATE INDEX IF NOT EXISTS idx_mood_student
    ON mood_checkins(student_id, checked_in_at DESC);

CREATE INDEX IF NOT EXISTS idx_mood_device
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_daily_motivation_device_date
